function get() {
	$('AmIRegistered_Control.php', { userFirstName: userInfo.firstName.value, userMiddleName: userInfo.middleName.value,userLastName: userInfo.lastName.value, userDob: userInfo.dob.value, userAddressZip: userInfo.addressZip.value, userIdNum: userInfo.idNum.value },
		function(output) {
