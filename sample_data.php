...
$sql = "SELECT `id`, `first_name`, `middle_name`, `last_name`, `email`, `address_line_1`, `address_line_2`, `address_village`, `address_zip`, `ID_type`, `ID_num`, `date_issued`, `date_expired`, `height`, `weight`, `hair`, `eye`, `sex`, `class`, `endorsements`, `restrictions`, `dob` FROM `2015_12d` ";

// use these for dbugging... WHERE `first_name` = 'jeremy' AND `middle_name` = 'scott' AND `last_name` = 'berry' AND `dob` = '10/31/1960' AND `address_zip` = '96912' AND `ID_num` = '1129653294' 
